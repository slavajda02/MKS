...
void StartAcceleroT(void const * argument);
...
int main(void)
{
  ...
  osThreadDef(AcceleroTask, StartAcceleroT, osPriorityNormal, 0, 128);
...
/* USER CODE BEGIN Header_StartAcceleroT */
/**
* @brief Function implementing the AcceleroTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartAcceleroT */
void StartAcceleroT(void const * argument)
{
  /* USER CODE BEGIN StartAcceleroT */
  /* Infinite loop */
	int8_t whoamI = 0;
